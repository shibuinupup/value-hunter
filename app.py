...
# Used when buy_mode != USDC (your UI calls this "ETH" mode). This is in "wrapped native" units.
...
# =========================
# Notes:
# - USDC decimals are usually 6 (Circle native), but on BSC the commonly-used Binance-Peg USDC is 18.
# - "ETH" mode in the UI means "wrapped native route". We keep your UI unchanged.
CHAIN_CONFIG = {
    1: {
        "name": "Ethereum",
        "native_symbol": "ETH",
...
def evaluate_token_fast(
    ...
    min_out = MIN_USDC if buy_mode == "USDC" else MIN_WRAPPED_NATIVE
